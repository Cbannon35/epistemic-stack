...
a ChatGPT session loading a release through the MCP tools, and follow-up
questions answered from the released graph.}
...
\begin{itemize}
\item \href{https://youtu.be/e11pvJ_94LY?t=141}{2:21} --- the seeded
  commons and its case-study clusters.
\item \href{https://youtu.be/e11pvJ_94LY?t=182}{3:02} --- a full
  pipeline run: harness narration, claim extraction, synthesis, and the
  finished graph.
\item \href{https://youtu.be/e11pvJ_94LY?t=374}{6:14} --- multiplayer:
  presence, comments, live chat, and an eve tour.
\item \href{https://youtu.be/e11pvJ_94LY?t=499}{8:19} --- fork, merge
  request, review of incoming nodes, and acceptance.
\item \href{https://youtu.be/e11pvJ_94LY?t=608}{10:08} --- an external
  agent reading a release over MCP.
\end{itemize}
