...
\video{3:02}{182}{A delegated run: the brief, the narration from eve, nodes
...
\video{6:14}{374}{Two people and eve in one room: cursors, cursor chat, a
...
\video{10:08}{608}{An agent connected over MCP: the key mint, the agent's
...
\video{2:21}{141}{The three case-study graphs: hypotheses and credences for
...
\begin{itemize}
\item \href{https://youtu.be/e11pvJ_94LY?t=141}{2:21} --- the three
  case-study graphs in the commons.
\item \href{https://youtu.be/e11pvJ_94LY?t=182}{3:02} --- a delegated
  deep-research run writing into the shared graph.
\item \href{https://youtu.be/e11pvJ_94LY?t=374}{6:14} --- multiplayer:
  presence, cursors, cursor chat, comments, and an eve tour.
\item \href{https://youtu.be/e11pvJ_94LY?t=499}{8:19} --- fork, merge
  request, review of incoming nodes, and acceptance.
\item \href{https://youtu.be/e11pvJ_94LY?t=608}{10:08} --- an MCP agent
  as a first-class contributor.
\end{itemize}
